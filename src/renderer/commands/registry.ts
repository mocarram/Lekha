...
export const COMMANDS: CommandDef[] = [
  ...
  // Format - blocks
  { id: 'heading1', label: 'Heading 1', group: 'Paragraph', shortcut: '⌘1' },
  { id: 'heading2', label: 'Heading 2', group: 'Paragraph', shortcut: '⌘2' },
  { id: 'heading3', label: 'Heading 3', group: 'Paragraph', shortcut: '⌘3' },
  { id: 'heading4', label: 'Heading 4', group: 'Paragraph', shortcut: '⌘4' },
  { id: 'heading5', label: 'Heading 5', group: 'Paragraph', shortcut: '⌘5' },
  { id: 'heading6', label: 'Heading 6', group: 'Paragraph', shortcut: '⌘6' },
  { id: 'paragraph', label: 'Paragraph', group: 'Paragraph', shortcut: '⌘0' },
  { id: 'increaseHeading', label: 'Increase Heading Level', group: 'Paragraph', shortcut: '⌘⇧=' },
  { id: 'decreaseHeading', label: 'Decrease Heading Level', group: 'Paragraph', shortcut: '⌘⇧-' },
  { id: 'bulletList', label: 'Bullet List', group: 'Paragraph' },
  { id: 'orderedList', label: 'Ordered List', group: 'Paragraph' },
  { id: 'taskList', label: 'Task List', group: 'Paragraph' },
  { id: 'blockquote', label: 'Blockquote', group: 'Paragraph' },
  { id: 'codeBlock', label: 'Code Block', group: 'Paragraph' },
  { id: 'horizontalRule', label: 'Horizontal Rule', group: 'Paragraph' },
  { id: 'indent', label: 'Indent', group: 'Paragraph', shortcut: '⌘]' },
  { id: 'outdent', label: 'Outdent', group: 'Paragraph', shortcut: '⌘[' },
